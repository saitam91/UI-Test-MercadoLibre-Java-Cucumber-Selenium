...
public class MeliProductPage extends BasePage{
    ...
    private String selectItem="//div[@class='ui-search-result__wrapper']//div[@class='andes-card andes-card--flat andes-card--default ui-search-result shops__cardStyles ui-search-result--core andes-card--padding-default']//div[@class='ui-search-result__content-wrapper shops-custom-secondary-font']//div[@class='ui-search-item__group ui-search-item__group--title shops__items-group']//a[@title]";
